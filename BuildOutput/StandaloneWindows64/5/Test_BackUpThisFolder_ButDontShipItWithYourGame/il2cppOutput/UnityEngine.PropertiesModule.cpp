...
IL_0080:
	...
	}
	{
		...
		NullCheck(L_20);
		bool L_21;
		L_21 = VirtualFuncInvoker0< bool >::Invoke(36, L_20);
...
IL_004f:
	{
		...
		NullCheck(L_17);
		MethodInfo_t* L_21;
		L_21 = VirtualFuncInvoker1< MethodInfo_t*, TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(52, L_17, L_19);
		NullCheck(L_21);
		RuntimeObject* L_22;
...
IL_000f:
	{
		...
		NullCheck(L_3);
		MethodInfo_t* L_7;
		L_7 = VirtualFuncInvoker1< MethodInfo_t*, TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(52, L_3, L_5);
		NullCheck(L_7);
		RuntimeObject* L_8;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool U3CU3Ec_U3C_ctorU3Eb__10_0_m98A9F8B7DD2A14EBBB86606DCFE2CB988291758F (U3CU3Ec_t6D8C492F99FC36E8E3C273660058AF34514E0523* __this, MethodInfo_t* ___0_x, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_3);
		bool L_4;
		L_4 = VirtualFuncInvoker0< bool >::Invoke(36, L_3);
		G_B3_0 = ((int32_t)(L_4));
		goto IL_001b;
	}
